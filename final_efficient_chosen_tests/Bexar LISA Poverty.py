...
# Load ZIP-level Bexar County data
...
# Load Texas ZIP shapefile and filter for ZIPs in the dataset
...
# Merge poverty rate into GeoDataFrame
...
# Run local Moran’s I on poverty rate
